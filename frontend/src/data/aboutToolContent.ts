...
export const ABOUT_TOOL_DOC: AboutToolDoc = {
  ...
  sections: [
      ...
      subsections: [
        {
          ...
          points: [
            ...
            'Job Deletion with Safety: Bulk deletion with dependency validation and 90-day recovery',
    ...
    },
    {
      ...
      intro: 'Safe deletion process with dependency checks, backup, and recovery capability.',
      diagram: {
        type: 'flow',
        description: 'Job deletion workflow with safety validation and recovery',
        nodes: [
          ...
          { id: 'backup', label: 'Backup Job Config\n(90-day retention)', type: 'process' },
        ...
        edges: [
          ...
          { from: 'warn', to: 'backup', label: 'Force Delete' },
      ...
      subsections: [
        {
          ...
          points: [
            ...
            'Status Check: Warns if job ran in last 7 days',
            'Active Instance Check: Prevents deletion while job is running',
            'Preview Mode: Shows what will be deleted before committing',
          ],
        },
        {
          title: 'Backup & Recovery',
          points: [
            'Automatic Backup: Full job config backed up to JSON store before deletion',
            '90-day Retention: Backups kept for 90 days, then auto-purged',
            'One-Click Recovery: Restore deleted jobs from Recovery Center',
            'Audit Trail: Complete deletion log with user, timestamp, reason',
          ],
        },
        {
          ...
          points: [
            ...
            'Orphan Prevention: Zero orphaned triggers left behind',
          ],
        },
      ],
    },
...
// Parser output:
{
  ...
  recommendation: "FREQ=INTERVAL;interval=30;units=minutes;window=09:00-17:00;days=Mon-Fri"
      ...
      subsections: [
        ...
        },
        {
          ...
          points: [
            ...
            '90-Day Backup Retention: Deleted jobs recoverable for 90 days',
          ],
        },
        {
    ...
    },
    {
      ...
      table: {
        ...
        rows: [
          ...
          ['/api/deletion/recovery', 'GET', 'List recoverable deleted jobs', 'Session ID'],
          ['/api/deletion/restore', 'POST', 'Restore deleted job', 'Session ID'],
        ],
      },
    },
    {
    ...
    },
    {
      ...
      intro: 'Get help with the StoneBranch Automation Platform.',
      content: [
        '**Technical Support:**',
        'Email: stonebranch-automation@company.com',
        'Teams Channel: StoneBranch Automation Users',
        'Response Time: 2 business hours for critical issues',
        '',
        '**Documentation:**',
        'User Guide: Available in "How to Use" section',
        'SOP Documents: Downloadable from each SOP page',
        'API Docs: OpenAPI spec at /api/docs',
        '',
        '**Training:**',
        'New User Onboarding: 2-hour session (monthly)',
        'Advanced Training: 4-hour deep dive (quarterly)',
        'Self-Paced: Video tutorials in "How to Use" section',
        '',
        '**Feedback & Feature Requests:**',
        'Submit via MS Teams channel or email',
