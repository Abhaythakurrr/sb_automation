...
export const ABOUT_TOOL_DOC: AboutToolDoc = {
  ...
  sections: [
      ...
      subsections: [
        {
          ...
          points: [
            ...
            'Safe Job Deletion: Bulk deletion with dependency validation, Excel backup, and manual recovery',
    ...
    },
    {
      ...
      intro: 'Safe deletion process with dependency checks, Excel backup export, and manual recovery capability.',
      diagram: {
        type: 'flow',
        description: 'Job deletion workflow with safety validation and Excel backup',
        nodes: [
          ...
          { id: 'backup', label: 'Export Job Details\nto Excel (Backup)', type: 'process' },
          ...
          { id: 'notify', label: 'Send Teams\nNotification', type: 'process' },
          { id: 'end', label: 'Jobs Deleted\n(Excel backup saved locally)', type: 'end' },
        ],
        edges: [
          ...
          { from: 'warn', to: 'backup', label: 'Proceed' },
          { from: 'active', to: 'backup', label: 'No' },
          { from: 'backup', to: 'triggers' },
      ...
      subsections: [
        {
          ...
          points: [
            ...
            'Preview Mode: Shows complete job details before deletion',
          ],
        },
        {
          title: 'Excel Backup & Recovery',
          points: [
            'Automatic Export: Job details exported to Excel before deletion',
            'Complete Backup: All fields (name, type, agent, script, schedule, triggers) saved',
            'User-Managed Storage: Excel file saved to user\'s local machine',
            'Manual Recovery: Upload backup Excel to Job Creation page to recreate jobs',
            'Flexible Retention: User decides how long to keep backup files',
            'Audit Trail: Deletion logged with timestamp, user, and job details',
          ],
        },
        {
          title: 'Recovery Process',
          points: [
            'Step 1: User locates the Excel backup file from deletion',
            'Step 2: Navigate to Job Creation page',
            'Step 3: Upload the Excel backup file',
            'Step 4: Review parsed jobs (same as normal creation)',
            'Step 5: Execute creation to restore deleted jobs',
            'Note: Recovery is manual - user must have saved the Excel backup',
          ],
        },
        {
          ...
          points: [
            ...
            'Trigger Backup: Trigger details included in Excel export for recovery',
          ],
        },
      ],
    },
    {
      heading: 'Job Recovery Process',
      intro: 'Step-by-step guide to recover deleted jobs using Excel backups.',
      subsections: [
        {
          title: 'When to Use Recovery',
          points: [
            'Accidentally deleted jobs that are still needed',
            'Need to recreate jobs in a different environment (Dev → QA → Prod)',
            'Disaster recovery after UAC database issues',
            'Rollback after incorrect bulk deletion',
            'Clone jobs to different agent clusters or regions',
          ],
        },
        {
          title: 'Step 1: Locate Your Backup',
          points: [
            'Find the Excel file exported during deletion',
            'Backup filename format: JobDeletion_Backup_YYYY-MM-DD_HH-MM-SS.xlsx',
            'Check your Downloads folder or designated backup location',
            'Verify Excel contains all required job details',
          ],
        },
        {
          title: 'Step 2: Review Backup Contents',
          points: [
            'Open Excel file to verify data completeness',
            'Check columns: Job Name, Job Type, Job Workstation, Job Script',
            'Verify trigger details: Job Starttime, Scheduled Frequency, Job Timezone',
            'Edit if needed (e.g., rename jobs, change agents, update schedules)',
          ],
        },
        {
          title: 'Step 3: Upload to Job Creation Page',
          points: [
            'Navigate to Job Creation page in the portal',
            'Click "Upload File" button',
            'Select the Excel backup file',
            'Wait for parser to extract job rows',
          ],
        },
        {
          title: 'Step 4: Validate & Execute',
          points: [
            'Review parsed jobs in the data table',
            'Fix any validation errors (red highlights)',
            'Preview UAC payloads to confirm correctness',
            'Click "Execute Creation" to restore jobs',
            'Monitor progress log for success/failure',
          ],
        },
        {
          title: 'Important Notes',
          points: [
            'Recovery is NOT automatic - user must manually upload backup Excel',
            'UAC will reject if job names already exist (must delete or rename first)',
            'Triggers are created in DISABLED state - enable manually after testing',
            'No time limit - Excel backups can be used months or years later',
            'Recommended: Store backups in version control or shared drive',
          ],
        },
      ],
    },
      ...
      subsections: [
        ...
        },
        {
          ...
          points: [
            ...
            'Save Deletion Backups: Store Excel exports from deletions in safe location',
            'Check Logs: Review creation_log.json for detailed error messages',
            'Retry Failed: Use filtered Excel with only failed jobs',
            'Test Recovery: Verify backup Excel can recreate jobs in test environment',
            'Version Control: Consider storing backup files in Git or SharePoint',
          ],
        },
      ],
    },
