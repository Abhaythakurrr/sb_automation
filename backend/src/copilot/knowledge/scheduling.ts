...
export const SCHEDULE_EXAMPLES: ScheduleExample[] = [
  ...
  { say: 'every 5 minutes on Monday, Tuesday and Wednesday',
    means: 'Repeats every 5 minutes, but only on those three days.',
    fields: 'timeStyle Interval, timeInterval 5, simpleDateType Specific Days, mon/tue/wed true' },
  { say: 'every 30 minutes on weekdays',
    means: 'Repeats every 30 minutes on business days only.',
    fields: 'timeStyle Interval, timeInterval 30, simpleDateType Business Days' },
  { say: 'every other day at 09:00',
    means: 'Runs at 09:00 every second day, counting from the first run date.',
    fields: 'timeStyle Absolute, time 09:00, dayStyle Every, dayInterval 2' },
